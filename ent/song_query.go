...
func (sq *SongQuery) QueryArtists() *ArtistQuery {
	query := &ArtistQuery{config: sq.config}
...
func (sq *SongQuery) Clone() *SongQuery {
	...
	return &SongQuery{
		...
		withArtists: sq.withArtists.Clone(),
...
func (sq *SongQuery) WithArtists(opts ...func(*ArtistQuery)) *SongQuery {
	query := &ArtistQuery{config: sq.config}
	for _, opt := range opts {
		opt(query)
	}
	sq.withArtists = query
	return sq
}
